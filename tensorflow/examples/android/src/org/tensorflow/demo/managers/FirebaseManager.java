...
//     * recognizedSign.
//     *
//     * @param recognizedSign recognizedSign to be stored.
//     */
//    public static void createEvent(RecognizedSign recognizedSign){
//        FirebaseDatabase database = FirebaseDatabase.getInstance();
//
//        // Create new recognizedSign with unique key
//        DatabaseReference eventsRef = database.getReference("recognizedSign");
//        String eventId = eventsRef.push().getKey();
//        eventsRef.child(eventId).setValue(recognizedSign);
//
//        // Create the relation User - RecognizedSign
//        DatabaseReference userEventsRef = database.getReference("userSigns");
//        userEventsRef.child(AuthManager.sUser.getId()).child(eventId).setValue(recognizedSign.getIndex());
//    }
//}
